    ...
    <main style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          {/* Champ identifiant */}
          <div style={{ display: "flex", alignItems: "center", gap: "12px", border: "1px solid #B8D8E8", borderRadius: "999px", paddingTop: "13px", paddingBottom: "13px", paddingLeft: "20px", paddingRight: "20px" }}>
            ...
            <input
              ...
              style={{ flex: 1, outline: "none", fontSize: "14px", backgroundColor: "transparent", color: "#1E3A4A" }}
            />
          </div>
